...
export default function Dashboard({
    ...
    const statCards = [
        ...
        {
            title: "Totally Damaged",
            value: stats.total_damage,
            icon: ShieldAlert,
            color: "bg-red-600",
        },
    ];
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {statCards.map((card) => (
                        ...
                        >
                            <div
                                className={`${card.color} p-3 rounded-lg text-white shrink-0`}
                            >
                                <card.icon size={18} />
                            </div>
                            <div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    <div className="bg-white border border-gray-200 rounded-xl p-6">
                        ...
                        <h3 className="text-sm font-black text-gray-900 uppercase tracking-tight mb-6">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {top_vulnerable.map((r) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-3.5 text-sm font-bold text-gray-500">
                                            {r.barangay}
                                        </td>
                                            ...
                                            <div className="flex items-center justify-center gap-3">
                                                <div className="w-20 bg-gray-100 h-1.5 rounded-full overflow-hidden">
                                                    <div
                                                        ...
                                                        style={{
                                                            width: `${Math.min(r.vai_score, 100)}%`,
                                                        }}
                                                    />
                                                </div>
                                                <span className="font-black text-gray-900 text-sm w-6 text-right">
                                                    {r.vai_score}
                                                </span>
                                            </div>
                                        </td>
