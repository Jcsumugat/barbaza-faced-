...
const sampleRecord = {
    ...
    assistance_records: [
        {
            date: "2026-03-15",
            recipient_name: "John Sumugat",
            emergency_type: "Typhoon",
            assistance_provided: "Family Food Pack",
            unit: "Pack",
            quantity: 2,
            cost: 1500.0,
        ...
        },
        {
            ...
            recipient_name: "John Sumugat",
            emergency_type: "Typhoon",
            assistance_provided: "Cash Assistance",
            unit: "PHP",
            quantity: 1,
            cost: 3000.0,
            provider: "DSWD",
...
.page { width: 355mm; min-height: 210mm; background: white; display: flex; gap: 6mm; padding: 0 3mm; }
.copy { width: 50%; padding: 4mm 4mm 3mm 4mm; border: 0.3mm solid #000; position: relative; }
.copy + .copy { border-left: 0.3mm solid #000; }
...
.page2 { width: 355mm; min-height: 210mm; background: white; display: flex; flex-direction: row; gap: 6mm; padding: 0 3mm; }
.assistance-copy { width: 50%; padding: 4mm 4mm 3mm 4mm; border: 0.3mm solid #000; }
.assistance-copy + .assistance-copy { border-left: 0.3mm solid #000; }
...
.cut-line { width: 0; border-left: 0.3mm dashed #aaa; align-self: stretch; margin: 0 -3mm; }
...
function Checkbox({ checked, label }) {
    return (
        <span
            className="check-row"
            style={{ display: "inline-flex", alignItems: "center", gap: "1mm" }}
        >
            <span className="checkbox" style={{ checked: checked }}>
                {checked ? "✓" : ""}
            </span>
            <span>{label}</span>
        </span>
        ...
        <div className="copy">
            ...
            <div className="form-header">
                ...
                <div className="header-text">
                    ...
                    <div className="faced-title">
                        Family Assistance Card in
                        <br />
            ...
            <div className="fields-grid">
                ...
                <div className="field-row">
                    ...
                    <FieldCell
                        number="6"
                        label="Evacuation Center / Site"
                        value={record.evacuation_center || ""}
                        flex={1}
                    />
                </div>
            </div>
            ...
            <div className="fields-grid">
                ...
                <div className="field-row">
                    <FieldCell
                        number="15"
                        label="Civil Status"
                        value={record.civil_status}
                        flex={1}
                    />
                    <FieldCell
                        number="16"
                        label="Mother's Maiden Name"
                        value={record.mothers_maiden_name}
                        flex={1.5}
                    />
                    <FieldCell
                        number="17"
                ...
                <div className="field-row">
                    <FieldCell
                        ...
                        value={`₱${Number(record.monthly_income).toLocaleString()}`}
                        flex={1}
                    />
                    <FieldCell
                        number="20"
                        label="ID Card Presented"
                        value={record.id_presented}
                        flex={1.2}
                    />
                    <FieldCell
                        number="21"
            ...
            >
                <div className="field-cell" style={{ flex: 1 }}>
                    <span className="field-label">
                        <span className="field-number">23. </span>Permanent
                        Address — House/Block/Lot No. · Street · Subd./Village ·
            ...
            >
                <div className="field-cell" style={{ flex: 1 }}>
                    <span className="field-label">
                        <span className="field-number">24. </span>Others
                    </span>
                    <div
                        className="field-value"
                        style={{
            ...
            <div className="account-row">
                <div className="account-cell">
                    <span className="field-label">
                        <span className="field-number">26. </span>Bank/E-Wallet
                    </span>
                    <div className="field-value">{record.bank_provider}</div>
                </div>
                <div className="account-cell">
                    <span className="field-label">
                        <span className="field-number">27. </span>Account Name
                    </span>
                    <div className="field-value">{record.account_name}</div>
                </div>
                <div className="account-cell">
                    <span className="field-label">
                        <span className="field-number">28. </span>Account Type
                    </span>
                    <div className="field-value">{record.account_type}</div>
                </div>
                <div className="account-cell">
                    <span className="field-label">
                        <span className="field-number">29. </span>Account Number
                    </span>
            ...
            <div className="checkbox-section">
                ...
                <div className="checkbox-group">
                    <span className="checkbox-group-label">
                        31. Shelter Damage Classification:
                    </span>
            ...
            <div className="privacy-box">
                ...
                All data and information indicated herein shall be used for
                identification purposes for the implementation of disaster risk
                reduction and management (DRRM) programs, projects, and
                activities and its disclosure shall be in compliance to Republic
...
function AssistanceCopy({ record, copyType }) {
    const emptyRows = Math.max(
        0,
        14 - (record.assistance_records?.length || 0),
    );
        ...
        <div className="assistance-copy">
            ...
            >
                <span style={{ fontSize: "6pt" }}>
                    <strong>Family Head:</strong> {record.last_name},{" "}
                ...
                <span style={{ fontSize: "6pt" }}>
                    <strong>Municipality:</strong> {record.municipality}
                </span>
                <span style={{ fontSize: "6pt" }}>
            ...
            >
                <span style={{ fontSize: "6pt", fontWeight: "700" }}>
                    Total Cost:
                </span>
                <span
                    style={{
                ...
                >
                    ₱
                    {(
                        record.assistance_records?.reduce(
                            (s, a) => s + Number(a.cost),
                            0,
                        ) || 0
    ...
    return (
        <>
            ...
            >
                ...
                >
                    Set paper size to Legal (8.5 × 14 in), Landscape orientation
                </span>
            </div>
