                ...
                <div className="bg-white/5 border border-white/10 rounded-[2.5rem] p-10 shadow-2xl backdrop-blur-sm">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            {errors.email && (
                                <p className="text-red-400 text-xs font-bold mt-1.5">{errors.email}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.password && (
                                <p className="text-red-400 text-xs font-bold mt-1.5">{errors.password}</p>
                            )}
                        </div>
