...
import { ShieldCheck, Mail, Lock, LogIn, ArrowLeft, ShieldAlert } from 'lucide-react';
            ...
            <main className="flex-1 flex items-center justify-center px-6 py-16">
                <div className="w-full max-w-sm">
                    ...
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <div>
                            <p className="text-xs font-black text-gray-900 uppercase tracking-tight leading-none">MSWDO / Admin</p>
                            <p className="text-[9px] text-gray-400 font-bold uppercase tracking-widest leading-none mt-0.5">Municipal Level Access</p>
                        </div>
                    </div>
                    ...
                    <p className="text-xs text-gray-400 mb-8">
                        Full validation, approval workflows, SitRep generation, and user management.
                    </p>
